    ...
    return (
        <main>
            <section className=" my-4">
                ...
                <section className=' row row-cols-lg-3 row-cols-1 p-2'>
                    {classData.students?.map((a) => {
                        return (
                            <div className="p-2" data-aos="fade-up" data-aos-delay={100}>
                                <div className=" border-rpl bg-light p-4 rounded-4 ">
                                    <p className=" fw-semibold m-0">{a.name}</p>
                                    <p className=" fw-light m-0 text-secondary">{a.role}</p>
                                </div>
                            </div>
                        )
                    })}
