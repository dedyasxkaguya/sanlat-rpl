...
const Quranpage = () => {
    ...
    return (
        <>
            <Navbar />
            <main className="col-10 col-lg-8 mx-auto shadow rounded-4 p-3" style={{ marginTop: '12dvh' }}>
                <div className="d-flex gap-2 mb-2 flex-column">
                    <span>Pilih fitur</span>
                    <div className="d-flex gap-2 justify-content-between justify-content-lg-start">
                        <Link to="/quran/ayah" className={` btn btn-light border p-2 px-4 ${active == 'ayah' ? 'btn-dark' : ''} d-none d-lg-block`}>
                            <i className="bi bi-search me-2 d-none d-lg-inline"></i>
                            <span>Cari teks</span>
                        </Link>
                        <Link to="/quran/read" className={` btn btn-light border p-2 px-4 ${active == 'read' ? 'btn-dark' : ''}`}>
                            <i className="bi bi-book me-2 d-none d-lg-inline"></i>
                            <span>Baca Quran</span>
                        </Link>
                        <Link to="/quran/count" className={` btn btn-light border p-2 px-4 ${active == 'count' ? 'btn-dark' : ''}`}>
                            <i className="bi bi-calculator me-2 d-none d-lg-inline"></i>
