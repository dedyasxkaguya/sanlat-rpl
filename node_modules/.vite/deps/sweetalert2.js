...
var isVisible$1 = (elem) => Boolean(elem && (elem.offsetWidth || elem.offsetHeight || elem.getClientRects().length));
var allButtonsAreHidden = () => !isVisible$1(getConfirmButton()) && !isVisible$1(getDenyButton()) && !isVisible$1(getCancelButton());
var isScrollable = (elem) => Boolean(elem.scrollHeight > elem.clientHeight);
...
var isSafariOrIOS = typeof window !== "undefined" && Boolean(window.GestureEvent);
var isIOS = isSafariOrIOS && /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream;
var iOSfix = () => {
...
var isJqueryElement = (elem) => typeof elem === "object" && elem !== null && "jquery" in elem;
